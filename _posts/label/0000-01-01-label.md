...
<style>
  ...
  content:url("/img/label/Illustration-label-EN.png");
}
html[lang=de] .label-image{
  content:url("/img/label/Illustration-label-DE.png");
}
...
<div class="container">
  <div class="row push-top push-bottom">
    <div class="text-center col-xs-12 col-sm-10 col-md-8 col-md-offset-2 col-sm-offset-1">
      ...
      <img class="responsive label-image" src="/img/label/Illustration-label-EN.png">
    ...
    <div class="row small-push-top small-push-bottom verticalAlign">
      <div class="col-xs-12 col-sm-4 col-md-3 col-md-offset-1">
        <div>
          ...
          <br />
          <p>All products with the Eaternity Label are rated by Climate Score, Water Footprint, Rainforest Label and Animal Welfare Label.</p>
      ...
      <div class="col-xs-12 col-sm-7 col-md-6 col-md-offset-1 slider">
        ...
        <table>
          <tr><td style="width:80px">3 stars:	</td><td>Is within the limits of a climate-friendly diet (40% less emissions than <a href="#average">the average</a>).</td></tr>
        ...
        <div>
          ...
          <div>
            ...
            <table>
              ...
              <tr><td>2 stars:	</td><td>Contains certified animal based.</td></tr>
            ...
            <div>
              ...
              <h2>Rainforest</h2>
              <p>We specify which certification the product has, or if it is free from palmoil and soja.</p>

              <table>
                <tr><td style="width:80px">3 stars:	</td><td>No critical products (only uncritical or certified).</td></tr>
  ...
  <div class="row push-top push-bottom verticalAlign">
    <div class="col-xs-12 col-sm-offset-1 col-sm-7">
      <div>
        ...
        <p>Give your consumers a sustainable choice when selecting their everyday food. Professional food producers use our solutions to create and label their products. The Eaternity Awards and 3-star ratings are based on a yearly reviewed LCA-database. It is currently the largest and most comprehensive database for carrying out environmental calculations for products. </p>
      </div>
    </div>
...
<div class="container">
  <div class="row small-push-top push-bottom verticalAlign">
    ...
    <div class="col-xs-offset-4 col-xs-4 col-sm-offset-0 col-sm-3 xs-push-top">
      <p>We will provide you with detailed scientific sustainability metrics, based on your food data. Given your prodcuts recipes – we can tell you where your are to reduce CO₂ emissions, your water footprint or approach a minimal risk diet for better health. Results of our calculations are provided as our label, that you can print on your product. As well as a complete transparent assessment, that consumers can access by scanning the products barcode with an app.</p>
    </div>
