...
<div class="row push-bottom">
  <div class="col-xs-offset-2 col-xs-8  col-sm-offset-0 col-sm-3">
    <img class="responsive" src="/img/partners/partner/Hilcona_Foodservice_logo.png">
  </div>
  <div class="col-xs-12 col-sm-offset-1 col-sm-8 xs-push-top">
    <h3>Hilcona</h3>
    <p>Hilcona was the first food producer to introduce a CO2 score in its public foodservice recipe database, effective August 2023. </p>

  <p>At a glance, (not only) kitchen professionals can immediately see the sustainability of the respective menus. The well over 600 Hilcona professional kitchen recipes (in D, E & F) can be filtered according to the CO2 Score via a cloud-based database. Access is via the Hilcona Foodservice homepage and is available to all. Additional benefit: The tried-and-tested recipes also support cooks in purchasing the right quantities of food. Food waste is thus avoided before it even occurs in the kitchen. A great help for the catering industry.
  </p>

   
    Learn more at <a href="https://foodservice.hilcona.com/de/126/Rezepte-fuer-Profis.html">Recipes for Professionals | Hilcona Foodservice</a>
  </div>
...
<!--       <p>You can use Pauli's Kitchen Solution to cover the need of restaurant businesses of all sizes. From simple recipe management to complex catering processes. With the new export function your recipes can be calculated directly with Eaternity.</p>-->
      ...
      Learn more at <a href="https://www.foodnotify.com/en/partners">www.foodnotify.com</a> 
    </div>
...
<!--       <p>You can use Pauli's Kitchen Solution to cover the need of restaurant businesses of all sizes. From simple recipe management to complex catering processes. With the new export function your recipes can be calculated directly with Eaternity.</p>-->
      ...
      Learn more at <a href="https://www.necta-group.com/co2-fussabdruck/">www.necta-group.com</a> 
    </div>
...
<!--       <p>You can use Pauli's Kitchen Solution to cover the need of restaurant businesses of all sizes. From simple recipe management to complex catering processes. With the new export function your recipes can be calculated directly with Eaternity.</p>-->
      ...
      Learn more at <a href="https://kost.at/partner/">kost.at</a> 
    </div>
...
<!--       <p>You can use Pauli's Kitchen Solution to cover the need of restaurant businesses of all sizes. From simple recipe management to complex catering processes. With the new export function your recipes can be calculated directly with Eaternity.</p>-->
      ...
      Learn more at <a href="https://www.gastro-smart.com">www.gastro-smart.com</a> 
    </div>
...
<!--       <p>You can use Pauli's Kitchen Solution to cover the need of restaurant businesses of all sizes. From simple recipe management to complex catering processes. With the new export function your recipes can be calculated directly with Eaternity.</p>-->
      ...
      Learn more at <a href="https://tl1.eu/tl1home/produkte/warenwirtschaft/index.html">tl1.eu</a> 
    </div>
...
<!--       <p>You can use Pauli's Kitchen Solution to cover the need of restaurant businesses of all sizes. From simple recipe management to complex catering processes. With the new export function your recipes can be calculated directly with Eaternity.</p>-->
      ...
      Learn more at <a href="https://www.parsleysoftware.com">www.parsleysoftware.com</a> 
    </div>
...
<!--       <p>You can use Pauli's Kitchen Solution to cover the need of restaurant businesses of all sizes. From simple recipe management to complex catering processes. With the new export function your recipes can be calculated directly with Eaternity.</p>-->
      ...
      Learn more at <a href="https://www.fourth.com/solution/inventory-management/recipe-menu-engineering-management">www.fourth.com</a> 
    </div>
  ...
  <div class="row push-bottom">
    <div class="col-xs-offset-2 col-xs-8  col-sm-offset-0 col-sm-3">
      <img class="responsive" src="/img/partners/matilda.svg">
    </div>
    <div class="col-xs-12 col-sm-offset-1 col-sm-8 xs-push-top">
      <h3 id="matilda">Matilda FoodTech - cloudMenu</h3>
      <p>The platform for sustainable management in gastronomy, catering and communal catering
Matilda FoodTech is the platform that bundles all management functions - from food purchasing and menu planning to serving, provision or delivery and tracking. In all of this, the focus is always on sustainability.</p>

      Learn more at <a href="https://www.matildafoodtech.com/">www.matildafoodtech.com</a>
    </div>
  </div>
...
<div class="row push-top push-bottom">
  ...
  <div class="row push-bottom">
    ...
    <div class="col-xs-12 col-sm-offset-1 col-sm-8 xs-push-top">
      <h3>Food for Future Freiburg</h3>
      <!-- <p>Calculate the CO₂ emissions of your food quickly and easily with the KlimaTeller App on your desktop or tablet: you enter the ingredients and their quantity and receive information in real time on how much emissions the dish causes. The App and calculations are provided by Eaternity.</p> -->
      Learn more at <a href="https://foodforfuturefreiburg.de/">foodforfuturefreiburg.de</a>
    </div>
  </div>
