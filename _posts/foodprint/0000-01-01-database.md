...
<div class="container">
  ...
  <div class="row push-bottom">
    <div class="col-xs-12 col-sm-offset-2 col-sm-8 text-center">
      <p>Eaternity's CO₂-values are based on life cycle assessments (LCAs) that exclusively use scientific accredited CO₂ equivalents.</p>
    </div>
  </div>
  ...
  <div id="reference" class="row big-push-bottom">
     <div class="col-xs-12 col-sm-offset-1 col-sm-10 text-center">
      <p>We have built up a solid, easy to understand and yearly peer reviewed CO₂-database. It is currently the largest and most comprehensive database for carrying out menu CO₂-calculations. We have extensive knowledge on life-cycle assessments and closely work with renowned scientists in the field. The life cycle assessment data basis currently includes more then 550 core ingredients and additional  individual options for organic, greenhouses, processing, packaging, conservation and more. All assessments are curated by scientists from Zurich University for applied Science (ZHAW), University of Zürich (UZH), Swiss Federal Institute of Technology in Zurich (ETHZ), Research Institute of Organic Agriculture (FiBL) and more.</p>
      <p>Calculations done with the Eaternity App hence include all Scope3 emission of the complete supply chain. They are calculated dynamically in real time, inclusive of life statistics of imports, transportation distances, and seasonalities. With an innovative automatic ingredient matching tool, all customer and supplier data is fitted seamlessly into our system.</p>
    </div>
  </div>
