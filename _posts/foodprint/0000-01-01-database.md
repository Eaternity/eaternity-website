...
<div class="container">
  ...
  <div class="row big-push-bottom">
     <div class="col-xs-12 col-sm-offset-1 col-sm-10 text-center">
      <p>We have built up a solid, easy to understand and yearly peer reviewed CO₂-database. It is currently the largest and most comprehensive database for carrying out menu CO₂-calculations. We have extensive knowledge on life-cycle assessments and closely work with renowned scientists in the field (e.g. Matthias Stucki at IUNR ZHAW). With an innovative automatic ingredient matching tool, all customer and supplier data fits seamlessly into our system.</p>
    </div>
  </div>
