...
<div class="container">
  ...
  <div class="row small-push-bottom">
     <div class="col-xs-12 col-sm-offset-1 col-sm-5 ">
       ...
       <p>Calculations done with the Eaternity App include all emission of the complete supply chain.</p>
    ...
    <div class="col-xs-12 col-sm-6">
      <div class="small-push-bottom">
        <p>
          ...
          <a href="/assets/sci-pub/Environmental+Impacts+of+Swiss+Consumption+and+Production.pdf">Now available here</a>
        </p>
      </div>
