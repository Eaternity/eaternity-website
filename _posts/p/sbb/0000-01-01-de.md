...
<div class="container">
  ...
  <div class="row push-bottom">
    <div class="col-xs-12 col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8 text-center">
      ...
      <p>Würden wir 3 mal die Woche klimafreundlich Essen, entspricht das für die Schweiz eine Einsparung von 1.13 Millionen Tonnen CO₂. Die Menge CO₂ die 1.13 Millionen weniger Autos auf den Schweizer Strassen entspricht.</p>
    </div>
  </div>
  ...
  <div class="row push-bottom small-push-top text-center">
    <div class="col-xs-12 col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8 text-center">
      <h4>Eaternity unterstützt den Swisstainable, dem Nachhaltigkeitsprogramm von Schweiz Tourismus zum Weltvegetariertag. Für die SBB Gerichte haben wir genauer hingeschaut.</h4>
    </div>
  </div>
  ...
  <div class="row push-bottom text-center">
    <div class="small-push-top col-xs-offset-2 col-xs-8 col-sm-offset-2 col-sm-4 col-md-offset-0 col-md-3">
      ...
      <ul class="text-left">
        ...
        <li>Der Transport der Zutaten verursacht lediglich 27 g CO₂. Das Aufwärmen im Restaurant 8 g CO₂, die Verpackung 11 g CO₂.</li>
    ...
    <div class="small-push-top col-xs-offset-2 col-xs-8 col-sm-offset-0 col-sm-4 col-md-offset-0 col-md-3">
      ...
      <ul class="text-left">
        ...
        <li>Der Transport der Zutaten verursacht lediglich 35 g CO₂. Das Aufwärmen im Restaurant 8 g CO₂, die Verpackung 11 g CO₂.</li>
    ...
    <div class="small-push-top col-xs-offset-2 col-xs-8 col-sm-offset-2 col-sm-4 col-md-offset-0 col-md-3">
      ...
      <ul class="text-left">
        ...
        <li>Die beste Zutat im Gericht ist das Bulgur, am meisten CO₂ verursacht die Cranberries.</li>
        <li>Der Transport der Zutaten verursacht lediglich 63 g CO₂. Das Aufwärmen im Restaurant 8 g CO₂, die Verpackung 11 g CO₂.</li>
    ...
    <div class="small-push-top col-xs-offset-2 col-xs-8 col-sm-offset-0 col-sm-4 col-md-offset-0 col-md-3">
      ...
      <ul class="text-left">
        ...
        <li>Der Transport der Zutaten verursacht lediglich 98 g CO₂. Das Aufwärmen im Restaurant 8 g CO₂, die Verpackung 11 g CO₂.</li>
  ...
  <div class="row push-top push-bottom">
    <div class="col-xs-12 col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8 text-center small-push-bottom">
      <p>Vegetarische Gerichte haben die bessere Klimabilanz. Im Vergleich spart ein typisches vegetarisches Gericht 48 % CO₂ ein, das sind für eine übliche Portion 825 g CO₂. </p>
  ...
  <div class="row push-bottom">
    <div class="col-xs-12 col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8 text-center">
      ...
      <a href=""><span class="button">Berechne deine eigenen Rezeptur im App<i class="fa fa-angle-right fa-lg"></i></span></a>
    </div>
  </div>
</div>
      ...
      <div class="row big-push-bottom">
        <div class="col-xs-12 col-sm-6">
          <div class="small-push-bottom">
            ...
            <p>
              Unserem Ernährungssystem werden 34% aller weltweiten CO2eq Emissionen zugerechnet. Bei 50 Gigatonnen im Jahr entspricht das auf die Weltbevölkerung wiederum etwas über 2 Tonnen pro Person und Jahr.
            </p><p>
              Weltweit konsumieren wir im Durchschnitt 2870 kcal am Tag und entsprechend 5.58 kg CO2 am Tag. 
            </p><p>
              Nach der Eat Lancet Studie von Marco Springmann, forder der Weltklimabericht eine Rduktion um mindestens 50%.
            </p>
          </div>
        ...
        <div class="col-xs-12 col-sm-6">
          <div class="small-push-bottom">
            ...
            <p>
              Die durch die Mahlzeiten verursachten Emissionen in kg CO₂-Äquivalent werden mit den durch die Nutzung von Mobiltelefonen verursachten Emissionen verglichen, um die Zahlen in einen gewissen Zusammenhang zu stellen. Die Herstellung eines Mobiltelefons verursacht etwa 85 kg CO₂, und der Strom, der zum Aufladen eines Telefons während seiner Lebensdauer (die durchschnittliche Lebensdauer in der EU5 beträgt 21.6 Monate) verbraucht wird, verursacht 1.6 g CO₂ pro Tag. Daraus können wir schließen, dass 1 kg CO2e den Emissionen von 7.5 Mobiltelefonen pro Tag entspricht.
            </p>
          </div>
