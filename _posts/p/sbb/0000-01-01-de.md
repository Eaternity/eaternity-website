...
<div class="container">
  ...
  <div class="row push-bottom small-push-top text-center">
    <div class="col-xs-12 col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8 text-center">
      <h3>Eaternity unterstützt den Swisstainable Veggie Day, einen Aktionstag von Schweiz Tourismus.</h3>
      <p>In diesem Rahmen werden am 1. Oktober - dem offiziellen Weltvegetariertag - mehr als 1'000 Schweizer Restaurants ihre Gäste mit einer regionalen, vegetarischen Küche verwöhnen. Auch die SBB Restaurants nehmen am Veggie Day teil und machen ihre Speisekarte gleich längerfristig vegetarischer. Hier haben wir etwas genauer hingeschaut.</p>
    </div>
  </div>

  <div class="row push-top small-push-bottom">
    <div class="col-xs-12 text-center">
      <h1>Veggie Aktion der SBB Restaurants</h1>
    </div>
  </div>
  <div class="row push-bottom text-center">
    <div class="small-push-top col-xs-offset-2 col-xs-8 col-sm-offset-2 col-sm-4 col-md-offset-0 col-md-3" id="menu1">
      ...
      <a href="http://sbb.ch/veggie-days">
    ...
    <div class="small-push-top col-xs-offset-2 col-xs-8 col-sm-offset-2 col-sm-4 col-md-offset-0 col-md-3" id="menu3">
      <h3>Bulgursalad mit Cranberries und Minze.<br /><br /></h3>
      <a href="http://sbb.ch/veggie-days">
        <div class="roundTeaser">
