...
<!-- 
 ...
 -->
  ...
  <div class="row push-bottom small-push-top text-center">
    <div class="col-xs-12 col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8 text-center">
      <h3>Eaternity supports Swisstainable, Switzerland Tourism's sustainability program for World Vegetarian Day. We took a closer look at the dishes served at SBB railroad restaurants</h3>.
    </div>
  </div>

  <div class="row push-top small-push-bottom">
    <div class="col-xs-12 text-center">
      <h1>Veggie campaign of the SBB railroad gastronomy</h1>
    </div>
  </div>
  <div class="row push-bottom text-center">
    <div class="small-push-top col-xs-offset-2 col-xs-8 col-sm-offset-2 col-sm-4 col-md-offset-0 col-md-3" id="menu1">
      <h3>Autumnal pumpkin ravioli with a curry-coconut sauce.</h3>
      <a href="">
      ...
      <ul class="text-left">
        <li>The CO₂ balance is 116 g CO₂ for a serving with 195 kcal. This corresponds to a saving of 225 g CO₂ (or 66%) compared to the average.</li>
        <li>The best ingredient in the dish is the curry coconut sauce, the most CO₂ causes the butter.</li>
    ...
    <div class="small-push-top col-xs-offset-2 col-xs-8 col-sm-offset-0 col-sm-4 col-md-offset-0 col-md-3" id="menu2">
      <h3>Creamy risotto with chanterelles.<br /><br /></h3>
      <a href="">
        <div class="roundTeaser">
      ...
      <ul class="text-left">
        <li>The CO₂ balance is 454 g CO₂ for a serving with 398 kcal. This corresponds to a saving of 267 g CO₂ (or 37%) compared to the average.</li>
        <li>The best ingredient in the dish is the egg sponge ragout, the most CO₂ causes the sauce to the risotto.</li>
    ...
    <div class="small-push-top col-xs-offset-2 col-xs-8 col-sm-offset-2 col-sm-4 col-md-offset-0 col-md-3" id="menu3">
      ...
      <ul class="text-left">
        <li>The CO₂ balance is 206 g CO₂ for a serving with 184 kcal. This corresponds to a saving of 143 g CO₂ (or 41%) compared to the average.</li>
        <li>The best ingredient in the dish is the bulgur, the most CO₂ cause the cranberries.</li>
    ...
    <div class="small-push-top col-xs-offset-2 col-xs-8 col-sm-offset-0 col-sm-4 col-md-offset-0 col-md-3" id="menu4">
      ...
      <ul class="text-left">
        <li>The CO₂ balance is 412 g CO₂ for a serving with 184 kcal. This corresponds to a saving of 484 g CO₂ (or 54%) compared to the average.</li>
        <li>The best ingredient in the dish is the Happy Vegi Butcher Chunks, the most CO₂ causing is the basmati rice.</li>
  ...
  <div class="container">
      ...
      <div class="row big-push-bottom">
        <div class="col-xs-12 col-sm-6">
          ...
          <div class="small-push-bottom">
            <h3>Calculation savings veggie menus and average</h3>
            <p>
          ...
          <div>
            ...
            <p>
              ...
              From this it follows that eating climate friendly 3 times a week has the same effect as 1.13 million cars less on Swiss roads.
            </p>
          </div>
        </div>
        <div class="col-xs-12 col-sm-6">
