  ...
  <div class="col-xs-12 col-md-12 push-top push-bottom">
      ...
      <div class="row">
        <div class="col-xs-12 col-md-12 ">
          ...
          <div class="teaserBox bgLightGrey">
            <p>Thanks to the use of scalable, digital software technologies, we can process large and complex volumes of data well. You may request a quote for our streamlined approach for the assessment of the CO2, water, and environmental-scores for a large number of products.</p>
          </div>
        </div>
