...
<div class="bgDarkBlue viewPortHeight" style="overflow:hidden;">
  ...
  <div class="row small-push-top small-push-bottom">
    <div class="col-xs-12 col-sm-6">
      <h2>Establish healthy and climate-friendly meals.</h2>
      </div>
    </div>
      <div class="row  push-bottom">
        <div class="col-xs-12 col-sm-4">
      <h4>As a restaurant or food professionals, get the most precise assessment of your food’s CO₂ emissions.  Go ahead and create profit for people, planet and your business.</h4> <h4 style="margin-top:10px;"><a href="/app" style="margin-right:40px;">Learn more <i class="fa fa-angle-right fa-lg"></i></a> <a href="mailto:license@eaternity.ch">Buy <i class="fa fa-angle-right fa-lg"></i></a></h4>
      <a href="https://app.eaternity.ch" class="button large small-push-top">
        Try Eaternity for Free<i class="fa fa-angle-right fa-lg"></i>
      </a>
    </div>
  </div>
