...
<div class="bgDarkBlue viewPortHeight" style="overflow:hidden;">
  ...
  <div class="row small-push-top small-push-bottom">
    <div class="col-xs-12 col-sm-5">
      ...
      <a href="/score" style="margin-right:30px;">Score for food products <i class="fa fa-angle-right fa-lg"></i></a><br />
      <a href="/score" style="margin-right:30px;">Gastro for restaurants <i class="fa fa-angle-right fa-lg"></i></a></h4>
  ...
  <!-- </div>
    ...
    <div class="row"> -->
      ...
      <div class="col-xs-12 col-sm-7" style="padding:30px 0px 0px 0px;">
      <!--
      ...
      <iframe frameborder="0" class="header-funding-2" scrolling="no" style="margin:0px -180px -80px 30px;" src="https://wemakeit.com/widgets/projects/co-score-of-all-foods?type=wide&locale=en" width="556" height="372"></iframe> -->
        <img style="margin:-30px -180px -80px 30px;transform: rotate(0deg);" class="responsive header-image" src="/img/score/SandwichBiscuit13.jpg" />
  ...
  <div class="container">
    <div class="row small-push-top">
      <div class="col-xs-4 col-md-2 col-md-offset-1">
        <img src="/img/partners/partner/HR.jpg" width="180px" type="image/svg+xml" style="margin-top:0px;margin-top:-30px;width:180px"/>
      </div>
...
<div class="bgLightGrey">
  <div class="container">
    <div class="row small-push-top">
      <div class="col-xs-4 col-md-2 col-md-offset-1">
        <img src="/img/partners/partner/Saviva_FSLogo.jpg" width="180px" type="image/svg+xml" style="margin-top:0px;margin-top:-30px;width:180px"/>
      </div>
      <div class="col-xs-8 col-md-4">
        <p class="teaserText">
